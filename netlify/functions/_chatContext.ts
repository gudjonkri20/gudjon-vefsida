...
const sanitizedProjectLine = (project: Project): string => {
  const status = {
    public: 'Public',
    internal: 'Internal — for Icelandia ehf',
    research: 'Research',
    side: 'Side project',
  }[project.status];
...
# About Guðjón
- AI Specialist at Icelandia ehf (formerly Reykjavik Excursions) in Iceland, since 2024
...
- Internal projects (built for Icelandia ehf) MUST stay at the level of the descriptions above.
